package com.iglushkov.calories.ui.fooddata;
...
import com.iglushkov.calories.databinding.FoodDataFragmentBinding;
...
import com.iglushkov.calories.recycleradapter.FoodRecyclerAdapter;
...
public class FoodDataFragment extends Fragment {
    ...
    private void setFoodInfo() {
        List<com.iglushkov.calories.database.entity.Food> dbFoods = db.foodDao().getAllForAUser(((GlobalVariables) context.getApplication()).getUser().uid);
    ...
    private void setSumFoodInfoForADay(String date) {
        List<com.iglushkov.calories.database.entity.Food> listFoodForADayForUser = db.foodDao().getFoodForADay(date, ((GlobalVariables) context.getApplication()).getUser().uid);
